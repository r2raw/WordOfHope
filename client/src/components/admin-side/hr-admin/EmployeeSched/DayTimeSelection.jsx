...
function DayTimeSelection(props) {
  const { arrayNum, selectedDays, employeeSched } = props;
  const [disabledDays, setDisabledDays] = useState();
  const [selectedTime, setSelectedTime]= useState(dayjs("12:00 AM", "hh:mm A"));

  const handleTimeChange = (e, name) => {
    const time = dayjs(e).format("HH:mm:ss");
    const endTime = dayjs(e).add(12,"hour").format("HH:mm:ss")
    setSelectedTime(e)
    ...
    >
        ...
        <div className="time-container">
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <TimePicker label="Select time"
             value={dayjs("1970-01-01" + employeeSched[arrayNum].endTime)} disabled minutesStep={30} />
          </LocalizationProvider>
        </div>
      </div>
      <div className="day-checkbox">
        ...
        <input
          ...
          value="Sunday"
          checked={employeeSched[arrayNum].days.includes("Sunday") ? true : false}
          id={`day1${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Monday"
          checked={employeeSched[arrayNum].days.includes("Monday") ? true : false}
          id={`day2${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Tuesday"
          checked={employeeSched[arrayNum].days.includes("Tuesday") ? true : false}
          id={`day3${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Wednesday"
          checked={employeeSched[arrayNum].days.includes("Wednesday") ? true : false}
          id={`day4${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Thursday"
          checked={employeeSched[arrayNum].days.includes("Thursday") ? true : false}
          id={`day5${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Friday"
          checked={employeeSched[arrayNum].days.includes("Friday") ? true : false}
          id={`day6${arrayNum}`}
          disabled={
        ...
        <input
          ...
          onChange={handleCheckChange}
          value="Saturday"
          checked={employeeSched[arrayNum].days.includes("Saturday") ? true : false}
          id={`day7${arrayNum}`}
